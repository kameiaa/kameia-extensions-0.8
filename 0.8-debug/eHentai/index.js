...
exports.eHentaiInfo = {
    version: (0, exports.getExportVersion)('0.0.51'),
    name: 'e-hentai',
    icon: 'icon.png',
    author: 'kameia, loik',
    ...
    intents: types_1.SourceIntents.HOMEPAGE_SECTIONS | types_1.SourceIntents.MANGA_CHAPTERS | types_1.SourceIntents.SETTINGS_UI | types_1.SourceIntents.CLOUDFLARE_BYPASS_REQUIRED
};
class eHentai {
    constructor(cheerio) {
        this.cheerio = cheerio;
    ...
    async getSearchTags() {
        const categoriesTagSection = App.createTagSection({
        ...
        const tagSections = [categoriesTagSection];
        return tagSections;
    }
    ...
    async getMangaDetails(mangaId) {
        ...
        let languageStr = (0, eHentaiParser_1.parseLanguage)(data.tags);
        let mangaDetails = App.createMangaInfo({
...
function parseMenuListPage($, ignoreExpectedEntryAmount = false) {
    ...
    for (const manga of $('tr', 'table.itg.gltc').toArray()) {
        ...
        let id = '', title = '', image = '', subtitle = '';
        let details = { id, title, image, subtitle };
        (0, eHentaiHelper_1.getRowDetails)($, manga, details);
